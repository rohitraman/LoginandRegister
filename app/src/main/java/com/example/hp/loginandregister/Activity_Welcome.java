...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_view_details) {
            ...
            alertdialog.setMessage("Do you want to logout").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                @Override
            ...
            AlertDialog a_builder=alertdialog.create();
            a_builder.show();
